...
public class WESessionFactory extends EditSessionFactory {
	...
	@Override
	public EditSession getEditSession(LocalWorld world, int maxBlocks, BlockBag blockBag, LocalPlayer player) { return new HawkSession(world, maxBlocks, blockBag, player); }
